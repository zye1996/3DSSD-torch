...
DETECTION_COLOR_MAP = {'Car': (255, 255, 0), 'Truck': (255, 100, 0), 'Pedestrian': (0, 226, 255),
                       'Cyclist': (141, 40, 255), 'Van': (255, 0, 0), 'Misc': (255, 0, 255),
                       'Prediction': (0, 0, 255)} # color for detection, in format bgr
...
def publish_ego_car(ego_car_pub):
    ...
    mesh_marker.mesh_resource = "file:///home/yzy/PycharmProjects/AutoDrive/catkin_ws/src/kitti/bmw_x5/BMW X5 4.dae"
